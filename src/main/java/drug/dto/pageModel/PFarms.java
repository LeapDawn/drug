...
public class PFarms {
	...
	public void setFarmraisescope(String farmraisescope) {
		this.farmraisescope = farmraisescope == null ? null : farmraisescope
				.trim();
	}
	...
	public void setFarmraisetype(String farmraisetype) {
		this.farmraisetype = farmraisetype == null ? null : farmraisetype
				.trim();
	}
	...
	public void setFarmbuilddate(String farmbuilddate) {
		this.farmbuilddate = farmbuilddate == null ? null : farmbuilddate
				.trim();
	}
	...
	public String toString() {
		return "PFarms [farmname=" + farmname + ", farmaddress=" + farmaddress
				...
				+ addtime + ", adduser=" + adduser + ", errorMsg="
				+ getErrorMsg() + "]";
	}
}
